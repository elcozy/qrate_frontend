        ...
        <div className="sidebar">
          <div className="sidebar-logo">
            <a href="#" className="logo-icon">
              <img src="/images/qrate logo1-02 2.png" />
            </a>
          </div>
          <div className="sidebar-properties">
            ...
            <div className="sidebar-item">
              <Link to="./explore">
                <img src="/images/safari 1.svg" className="sidebar-icon" />
                <span className="sidebar-name">Explore</span>
              </Link>
            </div>
            <div className="sidebar-item">
              <Link to="./gallery">
                <img src="/images/artgallery.svg" className="sidebar-icon" />
                <span className="sidebar-name">Art Gallery</span>
              </Link>
            </div>
            <div className="sidebar-item">
              <Link to="./artist">
                <img src="/images/paint.svg" className="sidebar-icon" />
                <span className="sidebar-name">Artists</span>
              </Link>
            </div>
            <div className="sidebar-item">
              <Link to="./supplies">
                <img src="/images/artsupplies.svg" className="sidebar-icon" />
          ...
          >
            <div className="icon-sidebar-properties">
              <div className="icon-user-part user-stuff">
                ...
                <span>
                  {" "}
                  <img src="/images/artist-icon.svg" /> &nbsp;Artist
                </span>
              </div>
              <div className="main-properties">
                ...
                <div className="icon-sidebar-item">
                  <img src="/images/mobile-exhibition.svg" />
                  <span className="icon-sidebar-name">Exhibition</span>
                </div>
                <div className="icon-sidebar-item">
                  <img src="/images/catalogue.svg" />
          ...
          <div>
            <nav className="navbar icon-nav navbar-expand">
              <div className="nav navbar-nav icon-navbar">
                ...
                <a className="nav-item nav-link mobile user" href="#">
                  <img src="/images/user.png" />
                </a>
              </div>
