            ...
            <div className="explore-content pink">
              ...
              <div className="explore-content-body">
                <div className="explore-user-detail">
                  ...
                  <span className="explore-username">realgallery</span>{" "}
                  <input
                    className="follow"
                    value="Follow"
                    type="button"
                ...
                <div className="explore-content-text">
                  ...
                  <p>
                    The event took place on the 25th of August, 2020. It was an
                    event filled...
                  </p>
            ...
            <div className="explore-content orange">
              ...
              <div className="explore-content-body">
                ...
                <div className="explore-content-text">
                  ...
                  <p>
                    They say time eventually heals one’s wounds. But does it
                    really? The illustration titled “Deception in ...
                  </p>
                  <div className="user-reaction row container">
                    <div>
                      <i className="far fa-comment"></i>
