    ...
    <>
      ...
      <div className="home__main__card2__content">
        <div className="home__main__card2__upper">
          ...
          <img
            className="home__main__card2__icon"
            src={EllipseIcon}
            alt="EllipseIcon"
          />
        ...
        <p className="home__main__card2__body">
          Da Vinci’s masterpiece is probably the most recognized artwork in the
          world today, and the most visited. Also known as La Giaconda, the
          painting is believed to illustrate the wife of wealthy Florentine
          merchant Francesco di Bartolomeo del Giocondo.
        </p>
        <div className="home__main__card2__body-image__container">
          <img
            className="home__main__card2__body-image1"
            src={MonaLisa}
            alt="body"
          />
          <img
            className="home__main__card2__body-image2"
            src={Painting}
            alt="body"
          />
        </div>
        <div className="home__main__card2__lower">
          <div className="home__main__card2__lower__group1">
            <Link to="#!">
              <span onClick={onCommentClick}>
                <img
                  className="home__main__card2__lower__group1__icon1"
                  src={CommentIcon}
                  alt="CommentIcon"
                />
              </span>
          ...
          <div className="home__main__card2__lower__group3__container ml-auto">
            <Link to="#!">
              <img
                className="home__main__card2__lower__group3__icon1 pb-3 pr-2"
                src={share}
                alt="ShareIcon"
              />
            </Link>
