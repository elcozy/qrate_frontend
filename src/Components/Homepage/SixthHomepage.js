...
const SixthHomepage = (props) => {
	...
	if (props.display === "SixthPage") {
		return (
			<div className="wrapper bg-indigo" id="16">
				<div className="mw py-5 px-3 px-sm-5 py-5 py-md-auto">
					<div className="about d-flex flex-column justify-content-center align-items-center text-light px-4 px-sm-5 px-md-auto mwm" ref={animate}>
						...
						<p className="text-justify text-md-center">
							Once you create an account, you get to select from a list of art category to add to your feed. See something you
							like? Retweet it to make it your own. Add comments if you want. Others would do the same to yours. That's how it
							works here.
						</p>
