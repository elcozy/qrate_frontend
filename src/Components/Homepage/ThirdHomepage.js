...
const ThirdHomepage = (props) => {
  ...
  if (props.display === "ThirdPage") {
    return (
      <div className="wrapper bg-explore-art" id="13">
        <div className="mw py-5 px-3 px-sm-5 px-sm-5 py-5 py-md-auto">
          <div
            className="about d-flex flex-column justify-content-center align-items-center text-light text-center px-4 px-sm-5 px-md-auto mwm"
            ref={animate}
          >
            ...
            <p className="">
              Qrate is the easiest way to admire art you love and even buy it
              for your wall or as a gift
            </p>
          </div>
        </div>
      </div>
