             ...
             <a href="#" className="navbar-logo">   <img src="/images/qrate logo1-02 2.png" alt="" /></a>
                ...
                <div className="nav justify-content-end">
                  ...
                  <svg  width="42"  height="42"  viewBox="0 0 42 42"  fill="none"  xmlns="http://www.w3.org/2000/svg">
                   ...
                   <span className="pl-3" style={{color: "#f7931e"}}>Exhibition</span></a>
                   <NavLink
               ...
               <div className="row-section">
                   <div className="video-section">
                       <div className="container-fluid live-vid">
                        ...
                        <div className="attendees" style={{paddingTop: "16px"}}>
                              ...
                              <span style={{paddingRight: "9px", paddingLeft: "9px"}}><img src="/images/circle.svg" alt=""></img></span>
                              <span className="date">24th Jan 2020</span>        
                        </div>
                       </div>
                       </div>
                       <div className="joining">
                         <div className="user"><img src="images/user.png"></img><span className="user-detail">artistGod joined the event</span></div>
                         <div className="user"><img src="images/user.png"></img><span className="user-detail">artistGod joined the event</span></div>
                         <div className="user"><img src="images/user.png"></img><span className="user-detail">artistGod joined the event</span></div>
                   ...
                   <div className="comment-section">
                       ...
                       <div className="message">
                           <span className=" mt-1"><img src="images/chat-user.svg" alt="user"></img></span>
                         <span className=" text col">Hi everyone 👋👋</span>
                         </div>
                         <div className="message">
                           <span className=" mt-1"><img src="images/chat-user.svg" alt="user"></img></span>
                         <span className=" text col">Hi, I’m Osinachi Patrick. I’m just joining. Am I missing anything?</span>
                         </div>
                       ...
                       <div className="text-area">
                        ...
                        <form className="form-inline">
                          ...
                          <span className="user"><img src="images/user.png"></img></span>
                            <input type="text" name="" id="" className="send-input" placeholder="Write a comment" aria-describedby="helpId"></input>
                         <button type="submit" className="submit btn"><img src="images/send.svg" alt=""></img> </button>
                          </div>
                        </form>
                         </div>
                       </div>
